...
Welcome! this repository contains my complete walkthrough of BOSS of the SOC (BOTS) Version 1 – Scenario 1: Web Defacement &  Scenario 2: Web Defacement (https://bots.splunk.com/).
